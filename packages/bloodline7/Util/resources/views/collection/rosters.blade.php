    ...
    <div id="list">
        ...
        <table class="table tableControl">
            ...
            <tr>
                ...
                <th scope="col" data-fn="position">Position</th>
                <th scope="col" data-fn="stats">Stats</th>
            ...
            @foreach ($data as $list)
                ...
                <tr data-pk="{{ $list->team_id }}|{{ $list->player_id }}">

                    <td>{{ $list->team->league->sport->sports_name }}</td>
                    <td>{{ $list->team->league->title }}</td>

                    <td>{{ $list->team->team_name }}</td>
                    <td>{{ $list->player->full_name }}</td>
                    <td>{{ $list->positon }}</td>
